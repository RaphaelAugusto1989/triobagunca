...
<span class="form-row border border-dark border-top-0 border-left-0 border-right-0 border-bottom-1 mb-3 ml-1 mt-3 mr-1 pb-2 font-weight-bold">DADOS: </span>
    <div class="form-row">
      <div class="form-group col-md-12">
          ...
          <input type="text" name="nome" id="inputname" class="form-control" placeholder="Nome" value="<?= $clb['nome_colab']." ".$clb['sobrenome_colab']; ?>" readonly>
        </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
          <label for="inputcpf">CPF:</label>
          <input type="text" name="cpf" id="inputcpf" class="cpf form-control" readonly value="<?= $clb['cpf_colab']; ?>">
        </div>
        <div class="form-group col-md-6">
          <label for="inputdate">Data de Nascimento:</label>
            <input type="text" name="nascimento" class="form-control data" id="inputdate" readonly value="<?=  date('d/m/Y', strtotime($clb['nasc_colab'])); ?>">
        </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6"">
                ...
                ?>
                <select  class="form-control" id="selectsexo" name="sexo" disabled>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="funcao" class="form-control" id="inputfuncao" readonly value="<?= $clb['funcao_colab']; ?>">
        </div>
      </div>
      <div class="form-group">
          <label for="inputfoto">Escolher sua foto:</label>
          <input type="file" name="foto" id="inputfoto" class="form-control">
          <input type="hidden" name="nome_foto" value="<?= $clb['foto_colab']; ?>">
      </div>
