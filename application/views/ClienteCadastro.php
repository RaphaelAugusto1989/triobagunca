...
<div class="container p-4">
	<form action="<?php echo base_url('Clientes/NewCliente');?>" method="POST">
		<p class="text-center">CADASTRO DO CLIENTE</p>
		<?php
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="inputcpf">CPF:</label>
      			<input type="text" name="cpf" class="form-control cpf" id="inputcpf" placeholder="Só Número" maxlength="11">
    		</div>
    		<div class="form-group col-md-6">
