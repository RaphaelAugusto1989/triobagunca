...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Mar-2019 às 19:14
...
(3, 'Raphael Augusto', 'Almeida Pereira', 'Analista de sistemas', '023.486.491-52', '1989-06-08', 'MASCULINO', '71919-180', 'Rua 36 Norte', 'Brasília', 'Norte (Águas Claras)', 'DF', 'Lote 3350', '(61) 3024-1097', '(61) 99278-8607', 'raphael.a.a.p@gmail.com', 'raphael', 'af79a8227f6f020dac98afce2a06d061', ''),
(4, 'Pedro', 'Almeida Pereira Sá', 'Menino', '023.486.491-52', '1989-06-08', 'MASCULINO', '72.020-045', 'CSD 4', 'Brasília', 'Taguatinga Sul (Taguating', 'DF', 'casa 02', '(61) 3024-1097', '(61) 99215-7766', 'raphael1989@gmail.com', 'Pedrinho', '', '');

-- --------------------------------------------------------

--
-- Estrutura da tabela `colaborador_evento`
--

CREATE TABLE `colaborador_evento` (
  `id_colab_evento` int(11) NOT NULL,
  `fk_id_evento` int(11) DEFAULT '0',
  `fk_id_colaborador` int(11) DEFAULT '0',
  `nome_colaborador` varchar(200) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `colaborador_evento`
--

INSERT INTO `colaborador_evento` (`id_colab_evento`, `fk_id_evento`, `fk_id_colaborador`, `nome_colaborador`) VALUES
(2, 16, 1, 'Administrador do Sistema'),
(4, 16, 1, 'Administrador do Sistema'),
(5, 16, 3, 'Raphael Augusto Almeida Pereira'),
(7, 22, 3, 'Raphael Augusto Almeida Pereira - Analista de sist'),
(8, 22, 1, 'Administrador do Sistema - Administrador');

-- --------------------------------------------------------

--
-- Estrutura da tabela `colaborador_indisponivel`
--

CREATE TABLE `colaborador_indisponivel` (
  `id_ind` int(11) NOT NULL,
  `id_colab` int(11) NOT NULL DEFAULT '0',
  `nome_colab` text,
  `data_cadastrado` date DEFAULT NULL,
...
--
-- Extraindo dados da tabela `colaborador_indisponivel`
--

INSERT INTO `colaborador_indisponivel` (`id_ind`, `id_colab`, `nome_colab`, `data_cadastrado`, `data_inicial`, `data_final`, `motivo_ind`) VALUES
(49, 1, NULL, '2019-03-11', '2019-03-13', '2019-03-13', 'Teste 1'),
(50, 1, 'Administrador do Sistema', '2019-03-12', '2019-03-23', '2019-03-24', 'Problemas Pessoais.'),
(51, 1, NULL, '2019-03-12', '2019-03-30', '2019-03-30', ''),
(52, 1, 'Administrador', '2019-03-12', '2019-04-01', '2019-04-06', ''),
(53, 1, 'Administrador', '2019-03-13', '2019-03-15', '2019-03-15', 'Teste 2');
...
CREATE TABLE `evento` (
  ...
  `numero_evento` varchar(9) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `complemento_evento` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `evento` (`id_evento`, `nome_cli`, `niver_cli`, `idade_niver`, `data_evento`, `email_cli`, `hora_evento`, `nome_mae`, `nome_pai`, `cep_evento`, `rua_evento`, `numero_evento`, `cidade_evento`, `bairro_evento`, `estado_evento`, `complemento_evento`, `nome_emergencia`, `numero_emergencia`, `qtd_crianca_evento`, `idade_media_evento`, `id_pct`, `especificacao_pct`, `psg_evento`, `hora_chegada`, `tempo_evento`, `hora_adicional`, `valor_pct`, `valor_total`, `sinal_valor`, `falta_pagar_valor`, `status_evento`) VALUES
(16, 'Carla da Silva Sá', 'Pedro Almeida Pereira Sá', '4', '2019-03-17', '', '17:00:00', 'Carla da Silva Sá', 'Raphael Augusto Almeida Pereira', '71919-180', 'Rua 36 Norte', '36', 'Brasília', 'Norte (Águas Claras)', 'DF', 'Lote 3350', 'Luciene', '(61) 30241-097', '200', '1 a 12', '2', 'Ficar 1 hora e meia no evento.', '    Todos', '18:00:00', '01:30:00', '00:01:50', '150,00', '350,00', '200,00', '200,00', 'Confirmado'),
(12, 'Raphael Augusto Almeida Pereira', 'Pedro Alme', '4', '2019-08-18', '', '18:00:00', '', '', '', '', '', '', '', '', '', 'Carla', '(61) 99215-776', '20', '1 a 8 anos', '1', 'Pacote de 2 horas de animação ou personagem vivo.', ' Homem Aranha', '19:00:00', '02:00:00', '00:02:50', '', '250,00', '150,00', '100,00', 'Confirmado'),
(17, 'Francisco de Sales Pereira', 'Rafaella Cecilia de Sousa Sales Pereira', '09', '2019-03-24', '', '18:00:00', '', '', '', '', '', '', '', '', '', '', '', '15', '4 a 12 Anos de ', '1', 'Pacote de 2 horas de animação ou personagem vivo.  ', 'Princesa Sophia  e animação', '19:00:00', '02:00:00', '00:02:50', '', '250,00', '250,00', '0,00', 'Cancelado'),
(20, 'Luciene Alves de Almeida', '', '', '2018-07-18', 'luciene@gmail.com', '16:00:00', '', '', '', '', '', '', '', '', '', '', '', '', '', '1', '', '', '00:00:00', '00:00:00', '00:00:00', '', '', '', '', 'Pendente'),
(21, 'Valmir lopes', '', '', '2019-03-15', 'valmir@gmail.com', '16:00:00', '', '', '', '', '', '', '', '', '', '', '', '', '', '2', 'Ficar 1 hora e meia no evento.', '', '00:00:00', '01:30:00', '00:00:00', '150,00', '', '', '', 'Pendente'),
(22, 'Luiz José Sem Pinto', '', '', '2019-03-23', 'jose.pinto@gmail.com', '14:00:00', '', '', '', '', '', '', '', '', '', '', '', '', '', '1', 'Pacote de 2 horas de animação ou personagem vivo. ', '', '00:00:00', '02:00:00', '00:00:00', '250,00', '', '', '', 'Pendente'),
(23, 'João de Deus da Silva Sem Pinto', '', '', '2019-03-29', 'joaosempinto@gmail.com', '16:00:00', '', '', '', '', '', '', '', '', '', '', '', '', '', '2', '', '', '00:00:00', '00:00:00', '00:00:00', '', '', '', '', 'Pendente');
...
--
-- Estrutura da tabela `permissao_colab`
--

CREATE TABLE `permissao_colab` (
  `id_permission` int(10) UNSIGNED NOT NULL,
  `nome_colab` varchar(200) DEFAULT NULL,
  ...
  `permission8` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `permissao_colab`
--

INSERT INTO `permissao_colab` (`id_permission`, `nome_colab`, `id_colab`, `permission1`, `permission2`, `permission3`, `permission4`, `permission5`, `permission6`, `permission7`, `permission8`) VALUES
...
--
-- Indexes for table `colaborador_evento`
--
ALTER TABLE `colaborador_evento`
  ADD PRIMARY KEY (`id_colab_evento`),
  ADD KEY `fk_colab` (`fk_id_colaborador`);

--
-- Indexes for table `colaborador_indisponivel`
--
ALTER TABLE `colaborador_indisponivel`
...
--
-- Indexes for table `permissao_colab`
--
ALTER TABLE `permissao_colab`
...
--
ALTER TABLE `colaborador`
  MODIFY `id_colab` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `colaborador_evento`
--
ALTER TABLE `colaborador_evento`
  MODIFY `id_colab_evento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `colaborador_indisponivel`
--
ALTER TABLE `colaborador_indisponivel`
  MODIFY `id_ind` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
-- AUTO_INCREMENT for table `permissao_colab`
--
ALTER TABLE `permissao_colab`
  MODIFY `id_permission` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- Limitadores para a tabela `colaborador_evento`
--
ALTER TABLE `colaborador_evento`
  ADD CONSTRAINT `fk_colab` FOREIGN KEY (`fk_id_colaborador`) REFERENCES `colaborador` (`id_colab`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
