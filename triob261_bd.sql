...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2018 at 09:35 PM
...
(16, 'Carla da Silva Sá', 'Pedro Almeida Pereira Sá', '4', '2019-08-17', '17:00:00', 'Ra 36 Norte', 'Luciene', '(61) 30241-097', '200', '1 a 12', 'Pendente', 'Pacote de 2 horas de animação ou personagem vivo.', ' Todos', '18:00:00', '02:00:00', '250,00', '1.000,00', '1.000,00', '0,00', ''),
(12, 'Raphael Augusto Almeida Pereira', 'Pedro Alme', '4', '2019-07-18', '18:00:00', 'Rua 36 Norte Lote 3350', 'Carla', '(61) 99215-776', '20', '1 a 8 anos', 'Confirmado', 'Pacote de 2 horas de animação ou personagem vivo.', 'Homem Aranha', '19:00:00', '02:00:00', '250,00', '250,00', '150,00', '100,00', '');
...
--
-- Table structure for table `permissao_user`
--
...
--
-- Dumping data for table `permissao_user`
--
...
(1, 'Administrador do Sistema', NULL, '', 'MASCULINO', 'raphael.a.a.p@gmail.com', '999.999.999-99', '2018-11-25', 'admin', 'd243ee28aa5930dea901298cdeb2cb9f'),
...
(9, 'Raphael Augusto', 'Almeida Pereira', 'user9_11122018094009', NULL, 'raphael.a.a.p@gmail.com', '023.486.491-52', '1989-06-08', 'raphael', 'af79a8227f6f020dac98afce2a06d061');
...
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
